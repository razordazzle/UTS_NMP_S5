      ...
      override fun getItemCount():Int{return studentList.size}
        override fun onBindViewHolder(holder:StudentViewHolder,position:Int){
            ...
            if(student.foto.isNotEmpty()){
                val resourceId=context.resources.getIdentifier(student.foto.substringBefore("."),"drawable",context.packageName)
                if(resourceId!=0) holder.fotoImageView.setImageResource(resourceId)
                else holder.fotoImageView.setImageResource(R.drawable.ic_person_placeholder)
            }else holder.fotoImageView.setImageResource(R.drawable.ic_person_placeholder)
